        ...
        <div>
          ...
          >
            <SwitchCom
              ...
              initialChecked={props.checkedAlone}
              setChecked={props.setCheckedAlone}
            />
          </div>
          <div
            onClick={() => {
          ...
          >
            <SwitchCom
              ...
              userTagList={props.userTagList}
              initialChecked={props.checkedFriends}
              setChecked={props.setCheckedFriends}
            />
          </div>
          <div
            onClick={() => {
          ...
          >
            <SwitchCom
              ...
              userTagList={props.userTagList}
              initialChecked={props.checkedDate}
              setChecked={props.setCheckedDate}
            />
          </div>
          <div
            onClick={() => {
          ...
          >
            <SwitchCom
              ...
              tag={["幼児と", "幼児と"]}
              userTagList={props.userTagList}
              initialChecked={props.checkedKid1}
              setChecked={props.setCheckedKid1}
            />
          </div>
          <div
            onClick={() => {
          ...
          >
            <SwitchCom
              ...
              userTagList={props.userTagList}
              initialChecked={props.checkedKid2}
              setChecked={props.setCheckedKid2}
            />
          </div>
          <div
            onClick={() => {
          ...
          >
            <SwitchCom
              ...
              userTagList={props.userTagList}
              initialChecked={props.checkedKid3}
              setChecked={props.setCheckedKid3}
            />
          </div>

          <Button onClick={() => Logout()} style={{ marginBottom: "50px" }}>
